...
from mongodb_copy import DatabaseManager
import os
from dotenv import load_dotenv

load_dotenv()

app = FastAPI(title="MongoDB Database API",version="1.0.0.0")
...
async def get_all_posts():
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTPP_500_INTERNAL_SERVER_ERROR,
            detail=f"Internal server errror: {str(e)}"
        )

#delete(DELETE)user and their posts
