...
def main():
    ...
    if not check_api_connection():
        ...
        st.info("Run: 'python 18_fastmongo.py' to start the server")
        return
        ...
        if success and users:
            ...
            if selected_user_display:
                ...
                with col2:
                    ...
                    st.warning(" This will delete the user and all their posts! Are you sure?")
...
def dashboard_page():
    ...
    if users_success and post_success:
